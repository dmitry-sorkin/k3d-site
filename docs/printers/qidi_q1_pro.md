...
Для заглушки отверстия после переноса вентилятора можно воспользоваться скотчем или распечаатать [заглушку](./models/6015_fan_dummy.3mf){ download="6015_fan_dummy.3mf" }
