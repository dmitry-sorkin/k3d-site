...
[Купить QIDI Q1 Pro](https://alli.pub/70m48g?erid=2SDnjcd3FtE){ target="_blank" }
...
Не забудьте сохранить внесенные изменения и перезагрузить прошивку с помощью нажатия кнопки `Сохранить и перезагрузить`.
