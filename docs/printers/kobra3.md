...
Управляющая электроника по железу неплоха, но прошивка в стоке закрытая и крайне малофункциональна. Тем не менее, она очень просто переустанавливается на кастомную, после чего все необходимые функции появляются. Также касательно электроники стоит отметить хорошую комплектацию принтера - есть датчик наличия филамента, датчик движения филамента, акселерометры и на печатающей голове, и на столе. Докупать ничего не придётся.
...
Стоковая прошивка ужасна. Она очень сильно ограничивает возможности принтера т.к. в ней нет ни веб-интерфейса, дающего управлять принтером по сети, ни доступа к конфигурации, ни доступа к карте высот стола, ни возможности отправлять файлы на печать из распространенных слайсеров. Поэтому обязательно нужно перейти на кастомную прошивку т.к. она все эти возможности вернёт и даст нормально настроить принтер.

Скачать прошивку и прочитать инструкцию по её установке можно на [:simple-github: GitHub разработчика.](https://github.com/utkabobr/DuckPro-Kobra3/blob/master/README.ru.md){ .target="_blank" }
