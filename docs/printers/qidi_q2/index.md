...
В новой прошивке KAMP включен по умолчанию. Следующая инструкция нужна только для старых прошивок, в которых KAMP отключен. На прошивке `01.01.02.03` и более новых включать его описанным ниже способом не нужно.
