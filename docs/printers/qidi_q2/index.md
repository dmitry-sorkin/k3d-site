...
5. Раскомментируйте строку `[include Adaptive_Meshing.cfg]`;
...
2. В нём раскомментируйте `[include Line_Purge.cfg]`;
3. Установите значение параметра `variable_mesh_margin` на 10;
4. Установите значение параметра `variable_fuzz_amount` на 2;
