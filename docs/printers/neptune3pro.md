...
|:------------ |:------:|:----------- |
| Подающие колёса BMG | [:material-shopping:](https://alli.pub/6ttfke?erid=2SDnjcbpKmi "5A") | Учитывая, что калёные стоят не сильно дороже обычных, я бы взял их. Но и на обычных можно печатать композитами, если не допускать пробок |
