...
|:------------ |:------:|:----------- |
| Подающие колёса BMG | [:material-shopping:](https://alli.pub/6su0rm) | Учитывая, что калёные стоят не сильно дороже обычных, я бы взял их. Но и на обычных можно печатать композитами, если не допускать пробок |
...
| Наименование | Ссылка | Комментарий |
|:------------ |:------:|:----------- |
| Биметаллический термобарьер | [:material-shopping:](https://alli.pub/6t84tu) | Уменьшает откаты и к-фактор LA, даёт возможность греть хотэнд до 300°C[^1] и печатать композитами |
| Сопло медное с калёной вставкой Mk8 | [:material-shopping:](https://alli.pub/6t8x3k "Trianglelab") | Подходит под все типы филамента, включая композитные. Самый универсальный диаметр - 0.4мм, начинать лучше с него и покупать другие |
| Сопло латунное Mk8 | [:material-shopping:](https://alli.pub/6svf14) [:material-shopping:](https://alli.pub/6svf23) | Не подходит для композитов, зато стоит дешевле |
| Тефлоновая трубка 2х4мм | [:material-shopping:](https://alli.pub/6swc6m) | Когда будете менять термобарьер, придётся обрезать трубку. Со стоковой у вас будет только 1 попытка. Учитывая низкую цену трубки, рационально сразу взять 1 метр в комплект, пригодится |
...
Изменение длины хотэнда должно сопровождаться адаптацией системы охлаждения, иначе она будет дуть не на модель. Просто переносить штатный обдув ниже не имеет большого смысла т.к. он не очень мощный, а стоимость деталей под установку нового не велика. 
...
|:------------ |:------:|:----------- |
| Биметаллический термобарьер | [:material-shopping:](https://alli.pub/6t84tu) | Уменьшает откаты и к-фактор LA, даёт возможность греть хотэнд до 300°C[^1] и печатать композитами |
| Хитблок Volcano | [:material-shopping:](https://alli.pub/6sub37) | Увеличенная длина горячей зоны позволяет значительно увеличить МОР. Плюс к этому лучше прогревает ABS-подобные материалы, за счёт чего те лучше спекаются. Минус один - придётся переделывать обдув, но его и так и так менять рационально |
| Сопло Volcano медное с калёной вставкой | [:material-shopping:](https://alli.pub/6svezr "Trianglelab") | Стоит не сильно дороже стального закалённого, но заметно лучше прогревает пластик. Если взять диаметром 0.4мм, то можно будет печатать линии шириной от ~0.35 до 1мм всеми видами филамента (включая композиты) без необходимости менять сопло |
| Носок Volcano | [:material-shopping:](https://alli.pub/6swb62 "Trianglelab") | Чтобы резкое включение охлаждения не понижало температуру хотэнда |
| Термистор NTC100K B3950 в гильзе | [:material-shopping:](https://alli.pub/6swbaj "Trianglelab") | Стоковый не подойдёт к V6/Volcano хитблоку. Этот такой же по типу, но в гильзе, прошивку менять не придётся |
| Тефлоновая трубка 2х4мм | [:material-shopping:](https://alli.pub/6swc6m) | Когда будете менять термобарьер, придётся обрезать трубку. Со стоковой у вас будет только 1 попытка. Учитывая низкую цену трубки, рационально сразу взять 1 метр в комплект, пригодится |
| Вентиляторы 5015 | [:material-shopping:](https://alli.pub/6t1l2j "Younuon Cooling Store") | В лоте 2 вентилятора, вам столько и надо будет для установки очень производительной системы охлаждения|
...
| Наименование | Ссылка | Комментарий |
|:------------ |:------:|:----------- |
| BTT Pi | [:material-shopping:](https://alli.pub/6t0gjm "BTT Official store") | Одноплатный компьютер для перехода на Klipper. Устанавливается внутрь корпуса и не требует дополнительного питания. Есть готовые образы системы с предустановленной управляющей частью Klipper'а, что упростит процесс перепрошивки |
