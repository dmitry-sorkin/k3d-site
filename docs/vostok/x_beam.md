...
![](./pics/step_6/s6_models_orientation.png)
...
![](./pics/step_6/s6_lph_mount_threaded_inserts.png)
...
![](.\pics\step_6\s6_roller_assembly.png)
...
![](./pics/step_6/s6_y_carriage_nut_install.png)

Вставьте гайки м3 в углубления в `Y carriage base`.

![](./pics/step_6/s6_install_inner_screw.png)

Вставьте винт М3х6 с потайной головкой в указанное отверстие и зафиксируйте его так, чтобы он не выпадал, например, гайкой М3 или кусочком скотча с наружней стороны каретки.

![](./pics/step_6/s6_inner_rollers_install.png)

Сначала устанавливаются ролики вглубь каретки. Если собираете вариант с двумя печатающими головами, то сначала устанавливается нижний ролик (1), через него продевается винт М3х35 до центральной перегородки, после чего устанавливается верхний ролик (2) и винт продевается до гайки. Закручивать винт при этом не надо, так как это может сжать корпус каретки и будет сложно установить другие ролики.

Если собираете вариант с одной печатающей головой, то ролик (1) вам не нужен. Его можно заменить на кусочек трубочки, пару гаек М3 или не заменять вообще ничем.

![](./pics/step_6/s6_outer_rollers_install.png)

Оставшиеся ролики в каретки устанавливаются аналогичным способом, за исключением того, что тут заранее заклаывать винт М3х6 не нужно, его можно будет вставить позднее.

Со второй кареткой надо будет проделать те же манипуляции.

### Установка кареток оси Y

![](./pics/step_6/s6_beam_nuts_install.png)

В пазы (1) и (2) необходимо заложить по 2 пазовые гайки М4. 

В паз (3) закладываются пазовые гайки М3 для крепления рельсы оси Х. Количество этих гаек можно посмотреть в спецификации или рассчитать исходя из крепления рельсы в каждое второе отверстие.

![](./pics/step_6/s6_y_carriage_install.png)

На изображении показана установка только одной каретки. Со второй всё делается аналогично.

Установите каретку на профиль и убедитесь, что она зашла до конца. Если каретка не заходит до конца, то необходимо будет обработать углы в посадочном месте под профиль. Если всё встало как надо, то каретка крепится на два винта М4х12 с потайной головкой (2) и (3).

### Установка рельсы

### ![](./pics/step_6/s6_rail_install.png)
...
![](./pics/step_6/s6_x_carriage_roller_spacer_install.png)

Установите деталь `0.5XY print head roller spacer` так, как это указано на изображении выше. 

![](./pics/step_6/s6_x_carriage_rollers_install.png)

Установите ролики и вставьте винты M3x35

![](./pics/step_6/s6_x_carriage_nuts_install.png)
...
![](./pics/step_6/s6_y_axis_rails_nuts_install.png)

В указанные пазы снизу портала заложите пазовые гайки М3. Общее количество гаек можно посмотреть в спецификации или рассчитать исходя крепления рельс на каждое второе отверстие.

![](./pics/step_6/s6_y_axis_rail_install.png)
...
![](./pics/step_6/s6_mgn12_carriages_install.png)
