...
- Рекомендуется вести 220В провода отдельно от проводов 24В, и тем более отдельно от сигнальных проводов;
...
- Если будете использовать реле не по спецификации, то перед подключением проводов к ним внимательно ознакомьтесь со схемой реле. Большинство других реле требуют другого подключения;
- Chamber thermistor - термистор, снимающий температуру воздуха. Располагается на нагревателе термокамеры на специальной детали;
- Chamber heater thermistor - термистор, располагающийся на корпусе нагревателя термокамеры;
- В случае перевода нагревателя термокамеры на 24в питание, подключать в разъём HE0 напрямую, не через реле. Конфиг при этом менять не надо.
