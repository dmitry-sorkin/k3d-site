...
|:------------ |:------:|:---------- |
| Собранная рама | 1 | Собирается в шаге 3 |
| Нижняя панель зашивки | 1 ||
| Средняя панель зашивки | 1 ||
| Верхняя панель зашивки | 1 ||
| Боковая панель зашивки | 2 ||
| Винт М4х8 ISO 7380-2 | x | Количество зависит от габаритов принтера. Приблизительно посчитать можно сложив количество отверстий в указанных выше панелях зашивки |
| Гайка закладная М4 | x | Количество равно количеству винтов М4х8 |
...
## Установка панелей и регулировка рамы
...
!!! note "Обратите внимание, что во вспомогательный паз гайки закладываются снизу"
...
Прикрепите панель винтами М4х8 через все отверстия, кроме отмеченных :smile: . Так как панель устанавливается уже окончательно, то можно затянуть винты. Но не перетяните, так как акриловые панели от перетяжки лопаются, а композитные панели сминаются.
