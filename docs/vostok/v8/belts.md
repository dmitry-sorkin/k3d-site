...
2. Приблизительную длину ремня можно узнать в [спецификации](../../vostok/releases/index.md) в разделе `покупные изделия`. Учтите, что эта цифра считается очень приблизительно и, если отрезать кусок ремня именно такой длины, то его может не хватить. Поэтому, если купленный кусок ремня это позволяет, то рекомендуется протягивать его целиком и резать по месту. Таким образом вы точно не промахнетесь с его длиной;
...
Приблизительная длина ремня оси Y указана в [спецификации](../../vostok/releases/index.md) на странице `покупные изделия`. Учтите, что эта цифра считается очень приблизительно и, если отрезать кусок ремня именно такой длины, то его может не хватить. Поэтому, если купленный кусок ремня это позволяет, то рекомендуется протягивать его целиком и резать по месту. Таким образом вы точно не промахнетесь с его длиной.
...
Установите крепежную пластину ремня на каретку оси Y и закрепите с помощью 2 винтов М3x12 с потайной головкой. Затягивать крепление на данном этапе не нужно, необходимо чтобы крепежная пластина просто встала на своё место.
