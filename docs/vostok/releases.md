...
[:material-file-document: Спецификация](releases/073/BOM_v0.7.3.ods){ .md-button }

[:material-drawing-box: Генератор зашивки](releases/073/DXF_Generator_v0.7.2.html){ .md-button }

[:material-video-3d: Сборка в формате .step](releases/073/K3D_VOSTOK_v0.7.3.stp.7z){ .md-button }

[:material-video-3d: Сборка в формате .x_t](releases/073/K3D_VOSTOK_v0.7.3.x_t.7z){ .md-button }

[:material-printer-3d-nozzle: STL файлы для печати](releases/073/STL_v0.7.3.7z){ .md-button }
...
[:material-file-document: Спецификация](releases/072/BOM v0.7.2.ods){ .md-button } 

[:material-drawing-box: Генератор зашивки](releases/072/DXF Generator v0.7.2.html){ .md-button } 

[:material-video-3d: Сборка в формате .step](releases/072/K3D VOSTOK v0.7.2.stp.7z){ .md-button } 

[:material-video-3d: Сборка в формате .x_t](releases/072/K3D VOSTOK v0.7.2.x_t.7z){ .md-button } 

[:material-printer-3d-nozzle: STL файлы для печати](releases/072/STL v0.7.2.7z){ .md-button }
