...
- Исправлен ряд мелких багов в спецификации.
...
:material-github: [Релиз на github](https://github.com/dmitry-sorkin/K3D-VOSTOK/releases/tag/v0.7.1-alpha){ target="_blank" }
