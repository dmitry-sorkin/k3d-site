...
Сопло системы охлаждения прикручивается к мотору экструдера на 3 винта М3х5 с полукруглой головкой, которые идут в комплекте с экструдером. Затягивать винты на данном этапе не нужно.
...
=== "Marlin"
    ...
    ```
    #define NOZZLE_TO_PROBE_OFFSET { 33.75, -25.1, 0 }
    ```
