...
[:octicons-package-16: Скачать](https://k3d.tech/vostok/releases/latest/stl.7z){ .download-button data-file="stl.7z" }

<script>
  const fileUrl = "https://k3d.tech/vostok/releases/latest/stl.7z";
  const fileName = "stl.7z";
