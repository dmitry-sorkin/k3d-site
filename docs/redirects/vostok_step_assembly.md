...
[:octicons-package-16: Скачать](https://k3d.tech/vostok/releases/latest/assembly.stp.7z){ .download-button data-file="assembly.stp.7z" }

<script>
  const fileUrl = "https://k3d.tech/vostok/releases/latest/assembly.stp.7z";
  const fileName = "assembly.stp.7z";
