...
Можно, но для этого нужно специальное сопло. В идеале 0.15 мм, но, возможно, получится и с помощью 0.2 мм сопла, если на внешнем периметре использовать уменьшенную ширину линий. Толщину слоя стоит установить как можно меньше, к примеру, 0.05 мм.
