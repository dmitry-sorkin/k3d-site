...
Установите кронштейн на каретку оси Х своего принтера и закрепите двумя винтами М3x8 (1). После этого закрутите винт М3x6 (2).
...
- [Поддержать](https://donate.stream/dmitrysorkin){ target="blank" }
