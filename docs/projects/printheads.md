...
**K3D EBP** - проект максимально простой, но при этом хорошо работающей печатающей головы. Целью проекта было использовать как можно больше стандартных деталей и как можно меньше печатных. Как итог, в качестве подающего механизма используется распространенный и дешевый BMG, в качестве хотэнда - стандартные E3D V6 или E3D Volcano, а печатных детали всего 4, каждая из которых печатается без поддержек.
...
**K3D ESP** - проект продвинутой печатающей головы на основе экструдера Creality Sprite. Со стоковыми подающими колёсами этот экструдер будет отлично печатать твёрдыми материалами. Если заменить подающие колёса на кастомные от Fysetc, то получится печатать даже самыми мягкими и капризными эластомерами.
