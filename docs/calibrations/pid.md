...
В большинстве современных 3D-принтеров, калибровка PID доступна нажатием одной кнопки через экран или веб-интерфейс принтера. В таком случае просто воспользуйтесь этим пунктом меню и следуйте указаниям на экране.
