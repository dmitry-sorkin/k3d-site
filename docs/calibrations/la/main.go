...
func generate(this js.Value, i []js.Value) interface{} {
	...
	write(";generated by K3D PA Calibrator ", js.Global().Get("calibrator_version").String(), "\n",
		";Written by Dmitry Sorkin @ http://k3d.tech/, Kekht, YTKAB0BP and alex1989\n",
		fmt.Sprintf(";Bed size: %s:%s [mm]\n", fmt.Sprint(roundFloat(bedX, 1)), fmt.Sprint(roundFloat(bedY, 1))),
