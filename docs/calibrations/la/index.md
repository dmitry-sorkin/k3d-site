...
3. В появившемся окне выберите:
      ...
      5. Шаг коэффициента 0.01;
      6. Печатать значения коэффициентов вкл.
4. Сгенерируйте гкод и напечатайте его на принтере.
...
Недостаток PA проявляется как утолщение участка посередине. Избыток PA проявляется как утоньшение участка посередине. Вам необходимо найти такой сегмент, на котором толщина участка посередине будет максимально близка к толщине учатков по бокам.
...
Если вы планируете печатать на высоких ускорениях, то стоит постараться подобрать минимальное время сглажния, при котором не возникает дефектов. Для этого:
