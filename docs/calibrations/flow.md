...
- Все экструдеры дают разную недоэкструзию при разном объёмном расходе. На низко- и среднепроизводительных хотэндах (МОР до ~25 мм³/с) этот эффект почти незаметен и компенсировать его нет смысла. На высокопроизводительных хотэндах этот эффект заметен, и калибровку потока стоит проводить на том расходе, на котором планируете печатать этим материалом;
...
2. Установите следующие настройки:
      ...
      5. шаблон заполнения крышки - хорды Архимеда;
