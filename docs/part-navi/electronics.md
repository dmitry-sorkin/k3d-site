...
|:--- |:---:|:---:|:---:|:---:|:--- |
| BTT SKR Mini E3 V3 | 4x tmc2209 | 1 | 2 | [:material-shopping:](https://alli.pub/6t0dbc "BTT Official store") | Устанавливается в Ender-3/Ender-3Pro/Ender-3V2/Ender-3 Neo/Ender-3V2 Neo и подобные на штатные крепления. Для других принтеров интересна относительно низкой ценой и малыми габаритами |
...
| FYSETC Spider | 8x pololu | 3 | 6 | [:material-shopping:](https://alli.pub/6t0n4u "FYSETC Official store") | Выбор питания вентиляторов 5\12\24в. Питание драйверов до 60в. У 5в линии питания хватает мощности для подключения к ней одноплатников типа Raspberry/Orange Pi. Интересна тем, что, при сопоставимой с Octopus функциональности, меньше в габаритах |
| FLY Super8 Pro | 8x pololu | 5 | 10 | [:material-shopping:](https://alli.pub/6t0mxg "Mellow") | Выбор питания вентиляторов 5\12\24в. Питание драйверов до 48в. Сменные транзисторы на вентиляторы. У 5в линии питания хватает мощности для подключения к ней одноплатников типа Raspberry/Orange Pi. Мощный МК. |
