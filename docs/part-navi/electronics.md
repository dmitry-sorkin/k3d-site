...
| SN-04 | [:material-shopping:](https://alli.pub/6t1arc "Longwei Store") | Распространенный тип индуктивных датчиков. Срабатывает только об металл, то есть для использования только со стальными листами. Можно использовать как концевик |
...
| ![оптический концевик](pics/opt_endstop_2.png){ width=100 } | [:material-shopping:](https://alli.pub/6t1ewa "Kingroon Official Store") | Оптический концевик. 3-проводный разъём xh2.54 с той же стороны, где и сам концевик |
...
| K1 camera | [:material-shopping:](https://alli.pub/6t1oa1 "Ender 3D Printer Online Store") | Камера для установки на Creality K1 или K1 Max. Дешевая, даёт HD разрешение. Имеет нестандартный разъём, для подключения к другим принтерам придётся делать кастомную проводку к камере |
