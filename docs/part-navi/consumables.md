...
2. Так как нагрузки в 3D-принтерах небольшие, то не имеет смысла гнаться за топовыми характеристиками смазок. Сойдёт любая, пригодная для открытых подшипников и не вступающая в реакцию с пластиками и металлами, используемыми на 3D-принтерах. Наиболее распространённая и дешёвая из таких - Литол-24;
3. Смазывать надо направляющие и ходовые винты. Колёса Openbuilds, бронзово-графитовые втулки и детали экструдеров не смазываются, кроме редких исключений;
...
6. Перед пересмазкой стоит удалить старую смазку с помощью растворителя и ветоши.
...
На него очень хорошо липнут почти все филаменты, включая даже `PP`, который мало куда еще липнет. Для полиамидов вообще самый сильный клей, вплоть до проблем с отделением детали после печати.
...
Вариантов полимера, на основе которых будет изготавливаться клей, чаще всего используется 2: PVP K-30 и PVP K-90. Оба не токсичны. Но K-30 дешевле и купить еще проще, а K-90 обеспечивает лучшую адгезию деталей к столу. Для печати крупных деталей из полиамидов, поликарбоната и прочих материалов с высокой усадкой, рекомендуется K-90.

Для приготовления клея необходимо просто смешать компоненты в пропорции 1 грамм PVP к 30 граммам спирта. Растворяется PVP медленно, но рано или поздно растворится. Полученный клей заливается в маркер, и наносится на стол тонким слоем.
...
| Наименование | Ссылки | Комментарий |
|:------------ |:------:|:----------- |
| Изопропанол | [:material-shopping:](https://www.ozon.ru/product/spirt-izopropilovyy-absolyutirovannyy-99-7-gost-1-l-511782155/){ target="_blank" } [:material-shopping:](https://www.wildberries.ru/catalog/213880149/detail.aspx){ target="_blank" } | Используется для разбавления БФ-2 и PVP, промывки направляющих и очистки деталей механики принтера. Для обезжиривания стола не лучший вариант т. к. оставляет тонкую плёнку, которая ухудшает адгезию деталей к столу |
