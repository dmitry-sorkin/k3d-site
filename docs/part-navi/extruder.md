...
| Creality Sprite Kit | [:simple-youtube:](https://youtu.be/mGZxazupZqU?t=343 "Часть обзора E3S1 посвящена спрайту"){ target="_blank" } | [:material-shopping:](https://alli.pub/6txmvr?erid=2SDnje89ywN "Creality 3D printer online store"){ target="_blank" } [:material-shopping:](https://alli.pub/6ttfgb?erid=2SDnjeSZ6ac "Creality 3d printer store"){ target="_blank" } | В комплекте стальное горло со сквозным прохождением трубки, хитблок CR-10, латунное сопло. Рекомендуется заменить горло на биметаллическое. |
...
| Наименование | Обзор\Тест | Ссылки | Комментарий |
|:------------ |:----------:|:------:|:----------- |
| BMG 5A | - | [:material-shopping:](https://alli.pub/6ttfho?erid=2SDnjbqLhKN "5A. Выбирать Right clear hardened"){ target="_blank" } | Вариант с низкокачественным корпусом, но хорошими подающими колёсами. Под печать только твёрдыми филаментами или в качестве донора для других проектов |
...
| Creality Sprite Extrusion Kit | [:material-shopping:](https://alli.pub/6tuu8h?erid=2SDnjeU3kuE "CREALITY 3D Printer Official Store"){ target="_blank" } | Для замены подающих колёс в Creality Sprite |
...
| Наименование | Ссылки | Комментарий |
|:------------ |:------:|:----------- |
| Радиатор E3D V6 | [:material-shopping:](https://alli.pub/6ttfxf?erid=2SDnjcxaVCU "5A. Выбирать Bowden Wade"){ target="_blank" } [:material-shopping:](https://alli.pub/6ttfy0?erid=2SDnjdHrKrx "Trianglelab") | Под термобарьер с резьбой М7 (E3D V6) |
...
| Наименование | Обзор\Тест | Ссылки | Комментарий |
|:------------ |:----------:|:------:|:----------- |
| E3D V6 биметаллический сталь+медь | [:simple-youtube:](https://youtu.be/IsUzO5mi974 "Тест"){ target="_blank" } | [:material-shopping:](https://alli.pub/6ttg8p?erid=2SDnjeDEDVJ "5А. Выбирать threaded"){ target="_blank" } | Для радиатора E3D V6 |
| E3D V6 титановый цельнометаллический | [:simple-youtube:](https://youtu.be/IsUzO5mi974 "Тест"){ target="_blank" } | [:material-shopping:](https://alli.pub/6ttg8w?erid=2SDnjePc8Ti "5A. Выбирать titanium 1.75"){ target="_blank" } | Для радиатора E3D V6 |
| Chimera биметаллический сталь+медь | - | [:material-shopping:](https://alli.pub/6ttg9h?erid=2SDnjeYW49n "5А. Выбирать smooth"){ target="_blank" } | Для радиатора CR-10[^3], а также хотэндов на Neptune 3 Pro/Plus/Max[^3], FBG6 и других с цилиндрическим отверстием диаметром 7мм |
...
| Наименование | Обзор\Тест | Ссылки | Комментарий |
|:------------ |:----------:|:------:|:----------- |
| E3D V6 | [:simple-youtube:](https://youtu.be/WaITh4YVcQ8?t=1725){ target="_blank" } | [:material-shopping:](https://alli.pub/6ttgga?erid=2SDnjdPnwxC "5A"){ target="_blank" } [:material-shopping:](https://alli.pub/6ttgh9?erid=2SDnjdd8qVJ "5A"){ target="_blank" } | Под сопла v6, термистор в гильзе и стандартный нагреватель D6 L20 |
