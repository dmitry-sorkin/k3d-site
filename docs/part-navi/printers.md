...
<table class="printertable">
    <tbody>
        <tr class="upperprinterimgtr">
            <td colspan=2 style="text-align: center;"><img class="printerimg" src="../pics/kobra3.png"></img></td>
        </tr>
        <tr>
            <td rowspan="5" class="printerimgtd"><img class="printerimg" src="../pics/kobra3.png"></img></td>
            <td><b>Наименование</b></td>
            <td style="text-align: center;"><b>Anycubic Kobra 3</b></td>
        </tr>
        <tr>
            <td>Стоимость:</td>
        ...
        <tr>
            <td>Обзор:</td>
            <td style="text-align: center;"><a href="https://youtu.be/4Lj4GrW2LTA" target="_blank"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m10 15 5.19-3L10 9v6m11.56-7.83c.13.47.22 1.1.28 1.9.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 4.83-.25.9-.83 1.48-1.73 1.73-.47.13-1.33.22-2.65.28-1.3.07-2.49.1-3.59.1L12 19c-4.19 0-6.8-.16-7.83-.44-.9-.25-1.48-.83-1.73-1.73-.13-.47-.22-1.1-.28-1.9-.07-.8-.1-1.49-.1-2.09L2 12c0-2.19.16-3.8.44-4.83.25-.9.83-1.48 1.73-1.73.47-.13 1.33-.22 2.65-.28 1.3-.07 2.49-.1 3.59-.1L12 5c4.19 0 6.8.16 7.83.44.9.25 1.48.83 1.73 1.73Z"></path></svg></span> YouTube</a><br><a target="_blank" href="https://vk.com/video-168896673_456239645"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m9.489.004.729-.003h3.564l.73.003.914.01.433.007.418.011.403.014.388.016.374.021.36.025.345.03.333.033c1.74.196 2.933.616 3.833 1.516.9.9 1.32 2.092 1.516 3.833l.034.333.029.346.025.36.02.373.025.588.012.41.013.644.009.915.004.98-.001 3.313-.003.73-.01.914-.007.433-.011.418-.014.403-.016.388-.021.374-.025.36-.03.345-.033.333c-.196 1.74-.616 2.933-1.516 3.833-.9.9-2.092 1.32-3.833 1.516l-.333.034-.346.029-.36.025-.373.02-.588.025-.41.012-.644.013-.915.009-.98.004-3.313-.001-.73-.003-.914-.01-.433-.007-.418-.011-.403-.014-.388-.016-.374-.021-.36-.025-.345-.03-.333-.033c-1.74-.196-2.933-.616-3.833-1.516-.9-.9-1.32-2.092-1.516-3.833l-.034-.333-.029-.346-.025-.36-.02-.373-.025-.588-.012-.41-.013-.644-.009-.915-.004-.98.001-3.313.003-.73.01-.914.007-.433.011-.418.014-.403.016-.388.021-.374.025-.36.03-.345.033-.333c.196-1.74.616-2.933 1.516-3.833.9-.9 2.092-1.32 3.833-1.516l.333-.034.346-.029.36-.025.373-.02.588-.025.41-.012.644-.013.915-.009ZM6.79 7.3H4.05c.13 6.24 3.25 9.99 8.72 9.99h.31v-3.57c2.01.2 3.53 1.67 4.14 3.57h2.84c-.78-2.84-2.83-4.41-4.11-5.01 1.28-.74 3.08-2.54 3.51-4.98h-2.58c-.56 1.98-2.22 3.78-3.8 3.95V7.3H10.5v6.92c-1.6-.4-3.62-2.34-3.71-6.92Z"></path></svg></span> VK</a></td>
        </tr>
        <tr>
            <td>Купить:</td>
            <td style="text-align: center;"><a target="_blank" href="https://alli.pub/72c9b9?erid=2SDnjdq25kF"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 13a5 5 0 0 1-5-5h2a3 3 0 0 0 3 3 3 3 0 0 0 3-3h2a5 5 0 0 1-5 5m0-10a3 3 0 0 1 3 3H9a3 3 0 0 1 3-3m7 3h-2a5 5 0 0 0-5-5 5 5 0 0 0-5 5H5c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2Z"></path></svg></span> AliExpress</a></td>
        </tr>
    </tbody>
</table>

Механика отличается простотой, тишиной во время работы и ремонтопригодностью. Любые люфты и заедания практически исключены т.к. механика настраиваемая. При этом кобра спокойно печатает на ускорениях около 6000 мм/с^2, что является очень хорошим результатом, а также почти не рябит. Единственный минус - стол не регулируется, поэтому, если захотите печатать крупные технические детали, то придётся выставлять его в горизонт с помощью подкладывания регулировочных шайбочек под стойки, или переводить на пружины.

Печатающая голова удовлетворительная. Экструдер в печати эластомерами плох, способен справляться только со средне-мягкими, и то, не супер стабильно. Но на твёрдых филаментах проблем никаких. Хотэнд производительный, все расходники есть всех нужных видов и за весьма скромные деньги. Охлаждение среднее.

Управляющая электроника по железу неплоха, но прошивка в стоке закрытая и крайне малофункциональна. Тем не менее, она очень просто переустанавливается [на кастомную](https://github.com/utkabobr/DuckPro-Kobra3){ .target="_blank" }, после чего все необходимые функции появляются. Также касательно электроники стоит отметить хорошую комплектацию принтера - есть датчик наличия филамента, датчик движения филамента, акселерометры и на печатающей голове, и на столе. Докупать ничего не придётся.

Отличительной особенностью этого принтера является система автоматической смены материала Ace Pro. Она позволяет хранить и сушить филамент, автоматически загружать нужную катушку перед печатью, менять катушку при окончании филамента, а также позволяет печатать мультиматериальные модели, хоть это и расточительно по времени и филаменту.

Подробнее в обзоре на [Youtube](https://youtu.be/4Lj4GrW2LTA){ .target="_blank" } или [VK](https://youtu.be/4Lj4GrW2LTA){ .target="_blank" }.
...
<table class="altprinters">
    <tbody>
        ...
        <tr>
            ...
            <td><p><b><a href="https://alli.pub/6xtus8?erid=2SDnjcNDgeM">Elegoo Neptune 4</a></b>. По сравнению с коброй немного дешевле стоит, стол имеет регулировки, экструдер лучше печатает эластомерами и имеет более производительную систему охлаждения. Но большой процент брака по механике (подробнее в <a href="https://youtu.be/19Ylp_yEUPY" target="_blank" >видео</a>), область печати меньше, ускорения немного ниже, а также значительно более скудная комплектация (нет акселерометров, датчика движения филамента) и нет системы автоматической смены материала.<br><a href="../../printers/neptune4/"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13 9h5.5L13 3.5V9M6 2h8l6 6v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4c0-1.11.89-2 2-2m9 16v-2H6v2h9m3-4v-2H6v2h12Z"></path></svg></span> Подробнее + про исправление косяков</a></p></td>
        </tr>
    </tbody>
</table>
