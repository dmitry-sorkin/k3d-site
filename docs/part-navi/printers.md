...
<table class="altprinters">
    <tbody>
        ...
        <tr>
            ...
            <td><p><b>Bambu Lab P1S</b>. Принтер немного медленнее К1, дороже (примерно 80-90к), при этом рябит, нагрев стола ограничен 100 градусами. Зато экструдер отличный, детали в круг качественные и собран принтер хорошо, поставляется полностью настроенным и с неплохими профилями под распространенные филаменты. Плюс к нему есть AMS - система автоматической смены материала, которая позволяет печатать многоматериальные детали. В целом больше подходит для новичков и тех, кто вообще не хочет учиться работать с принтерами.</p></td>
        </tr>
    </tbody>
</table>
