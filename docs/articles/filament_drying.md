...
Из распространенных в печати материалов не гигроскопичны (то есть не впитывают влагу из воздуха) только PP и SBS. Все другие материалы, чаще всего, поставляются уже с завода мокрыми, даже если производитель уверяет, что сушит их. А также намокают во время хранения, кроме случаев хранения в специальных драйбоксах.
...
| Готовая сушилка | + Не нужно никак дорабатывать, всё сразу готово к эксплуатации. В том числе к печати из сушилки;<br>+ Хорошие модели работают относительно тихо;<br>+ Есть пресеты под разные филаменты, зачастую есть датчик влажности воздуха внутри.| - Готовых сушилок под PA6/PA6.6 нет, все греют максимум до 65. |
...
|:------------- |:-------------------------------:|:----------- |
| PLA | 45-50°C |  |
| PETG | 70°C | Если ваша сушилка не может достичь такой температуы, то можно сушить при температуре ниже, увеличив время сушки |
| ABS/ASA | 85-90°C | Если ваша сушилка не может достичь такой температуы, то можно сушить при температуре ниже, увеличив время сушки |
| HIPS | 70°C |  |
| PC | 110°C | Если ваша сушилка не может достичь такой температуы, то можно сушить при температуре ниже, увеличив время сушки |
| PA12 | 90°C | Если ваша сушилка не может достичь такой температуы, то можно сушить при температуре ниже, увеличив время сушки |
| PA6/PA6.6 | 80-100°C | При температуре ниже 80°C эти виды филамента не просушатся полностью даже если сушить неделю. При температурах выше ~80-90°C филамент начинает деградировать с тем большей скоростью, чем выше температура. Так что оптимальная стратегия сушки - просушить при ~90°C и, не передерживая в сушилке слишком долго, переместить в драйбокс |
...
Если интересующего вас филамента нет в списке, то можно прикинуть оптимальную температуру сушки самостоятельно. Для большинства полимеров оптимально будет сушить на температуре примерно на 10°C ниже, чем температура стеклования. Из этого правила есть исключения, например, ПА6. Но с большинством других материалов оно работает достаточно хорошо.
