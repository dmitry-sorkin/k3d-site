...
Согласно [тестам](https://youtu.be/9YaJ0wSKKHA?si=rqsQgO97AcGa4ukK), увеличение ширины линий до ~150% от диаметра сопла даёт наибольший прирост в прочности моделей поперёк слоёв. Таким образом получается, что выгоднее иметь сопло относительно небольшого диаметра 0.4-0.5мм и печатать через него линии шириной 0.6-0.8.
...
Согласно [тестам](https://www.youtube.com/watch?v=fbSQvJJjw2Q), наилучшие результаты по прочности будут при толщине слоя ~0.15мм для ширины линий 0.4мм. Так как другие толщины линий не тестировались, то нет точных данных что больше влияет на спекаемость слоёв: абсолютная величина толщины слоя (в миллиметрах) или относительная (в процентах от ширины линий). Поэтому, пока не проведены отвечающие на этот вопрос исследования, стоит обратить внимание на то, как меняется прочность при изменении толщины слоя. При заметном уменьшении толщины слоя прочность почти не падает, в то время как при увеличении толщина слоя выше некоторой границы наблюдается резкое падение прочности. Так что на данный момент оптимальным решением выглядит для любых ширин линий ставить толщину слоя 0.15мм, т.к. в этом случае мы практически гарантированно попадём в диапазон, где значимое понижение прочности еще не происходит.
...
Так как рябь возникает только в определенных диапазонах скоростей, а также на момент написания статьи неизвестно способов борьбы с этим дефектом, единственным вариантом печатать без ряби является избегание диапазонов скоростей, где она возникает. В случае, если рябь возникает на всех скоростях вплоть до очень больших, к примеру, 200мм/с, печать плохо спекающимися материалами может привести к необходимости выбора между рябью или плохой прочностью. 

Чтобы избежать этого, можно поставить необычное на первый взгляд сочетание скоростей: на внешние периметры высокую скорость, на внутренние периметры и заполнение низкую. В некоторых случаях это не помогает, и через внешний периметр проглядывает рябь на внутреннем. В таком случае придётся поставить порядок печати периметров снаружи-внутрь.
