...
До [калибровки точности](../../calibrations/accuracy/index.md) SV08 даёт ошибку до 0.65 мм на 145 мм. После калибровки размеры на тестовой модели укладывается в ±0.1 мм – хороший результат.
