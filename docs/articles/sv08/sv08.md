...
<div class="grid cards no-gap cols-3" markdown>
  ...
  - ![](./pics/sv08_hotend.png)

</div>

Печатающая голова полностью своя, не имеющая ничего общего с Voron Afterburner/Stealthburner. Но совместима с ними по креплениям и месту присоединения ремня. Поэтому печатающие головы, подготовленные под Voron 2.4, можно установить на Sovol SV08 без переделок.

Подающий механизм основан на Orbiter v2 и совместим с ним по основным деталям. Но подающие колёса низкокачественные, имеющие очень тупые зубчики. Это приводит к проблемам с экструзией, которые видны и по печати, и по тестам.
...
Система охлаждения на одной 5015 улитке формата Bambu Lab (с увеличенным выходом). Обдув радиатора хотэнда осуществляется вентилятором 3010.
